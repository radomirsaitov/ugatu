 ...
 * @author 1
 */
public class Расчетэлектрическихцепей extends javax.swing.JFrame {

    /**
     * Creates new form Расчетэлектрическихцепей
     */
    public Расчетэлектрическихцепей() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Форма2Расчет расчет = new Форма2Расчет();
        расчет.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Расчетэлектрическихцепей.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Расчетэлектрическихцепей().setVisible(true);
            }
        });
    }
